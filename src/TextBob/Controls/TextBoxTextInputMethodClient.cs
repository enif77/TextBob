...
namespace TextBob.Controls
{
    ...
    {
        private MultiselectTextBox? _parent;
        ...
        public override string SurroundingText
        {
            get
            {
                ...
                {
                    _presenter.SetCurrentValue(MultiselectTextPresenter.CaretIndexProperty, _parent.CaretIndex);
                }

                if (_parent.Text != _presenter.Text)
                {
                    _presenter.SetCurrentValue(MultiselectTextPresenter.TextProperty, _parent.Text);
                }
        ...
        public void SetPresenter(MultiselectTextPresenter? presenter, MultiselectTextBox? parent)
        {
            if (_parent != null)
            {
            ...
            {
                oldPresenter.ClearValue(MultiselectTextPresenter.PreeditTextProperty);
        ...
        public override void SetPreeditText(string? preeditText)
        {
            ...
            _presenter.SetCurrentValue(MultiselectTextPresenter.PreeditTextProperty, preeditText);
        }
        ...
        {
            if (e.Property == MultiselectTextBox.TextProperty)
            {
                RaiseSurroundingTextChanged();
            }

            if (e.Property == MultiselectTextBox.SelectionStartProperty || e.Property == MultiselectTextBox.SelectionEndProperty)
            {
                RaiseSelectionChanged();
            }
        }
