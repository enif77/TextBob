...
public partial class MultiselectTextBox : TemplatedControl, MultiselectTextBoxUndoRedoHelper<MultiselectTextBox.UndoRedoState>.IUndoRedoHost
{
    ...
    public static readonly StyledProperty<bool> AcceptsReturnProperty =
        AvaloniaProperty.Register<MultiselectTextBox, bool>(nameof(AcceptsReturn));

    /// <summary>
    /// Defines the <see cref="AcceptsTab"/> property
    /// </summary>
    public static readonly StyledProperty<bool> AcceptsTabProperty =
        AvaloniaProperty.Register<MultiselectTextBox, bool>(nameof(AcceptsTab));

    /// <summary>
    /// Defines the <see cref="CaretIndex"/> property
    /// </summary>
    public static readonly StyledProperty<int> CaretIndexProperty =
        AvaloniaProperty.Register<MultiselectTextBox, int>(nameof(CaretIndex),
    ...
    public static readonly StyledProperty<bool> IsReadOnlyProperty =
        AvaloniaProperty.Register<MultiselectTextBox, bool>(nameof(IsReadOnly));

    /// <summary>
    /// Defines the <see cref="PasswordChar"/> property
    /// </summary>
    public static readonly StyledProperty<char> PasswordCharProperty =
        AvaloniaProperty.Register<MultiselectTextBox, char>(nameof(PasswordChar));

    /// <summary>
    /// Defines the <see cref="SelectionBrush"/> property
    /// </summary>
    public static readonly StyledProperty<IBrush?> SelectionBrushProperty =
        AvaloniaProperty.Register<MultiselectTextBox, IBrush?>(nameof(SelectionBrush));

    /// <summary>
    /// Defines the <see cref="SelectionForegroundBrush"/> property
    /// </summary>
    public static readonly StyledProperty<IBrush?> SelectionForegroundBrushProperty =
        AvaloniaProperty.Register<MultiselectTextBox, IBrush?>(nameof(SelectionForegroundBrush));

    /// <summary>
    /// Defines the <see cref="CaretBrush"/> property
    /// </summary>
    public static readonly StyledProperty<IBrush?> CaretBrushProperty =
        AvaloniaProperty.Register<MultiselectTextBox, IBrush?>(nameof(CaretBrush));

    /// <summary>
    /// Defines the <see cref="SelectionStart"/> property
    /// </summary>
    public static readonly StyledProperty<int> SelectionStartProperty =
        AvaloniaProperty.Register<MultiselectTextBox, int>(nameof(SelectionStart),
            coerce: CoerceCaretIndex);
    ...
    public static readonly StyledProperty<int> SelectionEndProperty =
        AvaloniaProperty.Register<MultiselectTextBox, int>(nameof(SelectionEnd),
            coerce: CoerceCaretIndex);
    ...
    public static readonly StyledProperty<int> MaxLengthProperty =
        AvaloniaProperty.Register<MultiselectTextBox, int>(nameof(MaxLength));

    /// <summary>
    /// Defines the <see cref="MaxLines"/> property
    /// </summary>
    public static readonly StyledProperty<int> MaxLinesProperty =
        AvaloniaProperty.Register<MultiselectTextBox, int>(nameof(MaxLines));

    /// <summary>
    /// Defines the <see cref="Text"/> property
    /// </summary>
    public static readonly StyledProperty<string?> TextProperty =
        TextBlock.TextProperty.AddOwner<MultiselectTextBox>(new(
            coerce: CoerceText,
    ...
    public static readonly StyledProperty<TextAlignment> TextAlignmentProperty =
        TextBlock.TextAlignmentProperty.AddOwner<MultiselectTextBox>();

    /// <summary>
    /// Defines the <see cref="HorizontalAlignment"/> property.
    /// </summary>
    public static readonly StyledProperty<HorizontalAlignment> HorizontalContentAlignmentProperty =
        ContentControl.HorizontalContentAlignmentProperty.AddOwner<MultiselectTextBox>();

    /// <summary>
    /// Defines the <see cref="VerticalAlignment"/> property.
    /// </summary>
    public static readonly StyledProperty<VerticalAlignment> VerticalContentAlignmentProperty =
        ContentControl.VerticalContentAlignmentProperty.AddOwner<MultiselectTextBox>();

    public static readonly StyledProperty<TextWrapping> TextWrappingProperty =
        TextBlock.TextWrappingProperty.AddOwner<MultiselectTextBox>();

    /// <summary>
    /// Defines see <see cref="MultiselectTextPresenter.LineHeight"/> property.
    /// </summary>
    public static readonly StyledProperty<double> LineHeightProperty =
        TextBlock.LineHeightProperty.AddOwner<MultiselectTextBox>(new(defaultValue: double.NaN));

    /// <summary>
    /// Defines see <see cref="TextBlock.LetterSpacing"/> property.
    /// </summary>
    public static readonly StyledProperty<double> LetterSpacingProperty =
        TextBlock.LetterSpacingProperty.AddOwner<MultiselectTextBox>();

    /// <summary>
    /// Defines the <see cref="Watermark"/> property
    /// </summary>
    public static readonly StyledProperty<string?> WatermarkProperty =
        AvaloniaProperty.Register<MultiselectTextBox, string?>(nameof(Watermark));

    /// <summary>
    /// Defines the <see cref="UseFloatingWatermark"/> property
    /// </summary>
    public static readonly StyledProperty<bool> UseFloatingWatermarkProperty =
        AvaloniaProperty.Register<MultiselectTextBox, bool>(nameof(UseFloatingWatermark));

    /// <summary>
    /// Defines the <see cref="NewLine"/> property
    /// </summary>
    public static readonly StyledProperty<string> NewLineProperty =
        AvaloniaProperty.Register<MultiselectTextBox, string>(nameof(NewLine), Environment.NewLine);

    /// <summary>
    /// Defines the <see cref="InnerLeftContent"/> property
    /// </summary>
    public static readonly StyledProperty<object> InnerLeftContentProperty =
        AvaloniaProperty.Register<MultiselectTextBox, object>(nameof(InnerLeftContent));

    /// <summary>
    /// Defines the <see cref="InnerRightContent"/> property
    /// </summary>
    public static readonly StyledProperty<object> InnerRightContentProperty =
        AvaloniaProperty.Register<MultiselectTextBox, object>(nameof(InnerRightContent));

    /// <summary>
    /// Defines the <see cref="RevealPassword"/> property
    /// </summary>
    public static readonly StyledProperty<bool> RevealPasswordProperty =
        AvaloniaProperty.Register<MultiselectTextBox, bool>(nameof(RevealPassword));

    /// <summary>
    /// Defines the <see cref="CanCut"/> property
    /// </summary>
    public static readonly DirectProperty<MultiselectTextBox, bool> CanCutProperty =
        AvaloniaProperty.RegisterDirect<MultiselectTextBox, bool>(
            nameof(CanCut),
            o => o.CanCut);
    ...
    /// </summary>
    public static readonly DirectProperty<MultiselectTextBox, bool> CanCopyProperty =
        AvaloniaProperty.RegisterDirect<MultiselectTextBox, bool>(
            nameof(CanCopy),
            o => o.CanCopy);
    ...
    /// </summary>
    public static readonly DirectProperty<MultiselectTextBox, bool> CanPasteProperty =
        AvaloniaProperty.RegisterDirect<MultiselectTextBox, bool>(
            nameof(CanPaste),
            o => o.CanPaste);
    ...
    public static readonly StyledProperty<bool> IsUndoEnabledProperty =
        AvaloniaProperty.Register<MultiselectTextBox, bool>(
    ...
    /// </summary>
    public static readonly DirectProperty<MultiselectTextBox, bool> CanUndoProperty =
        AvaloniaProperty.RegisterDirect<MultiselectTextBox, bool>(nameof(CanUndo), x => x.CanUndo);

    /// <summary>
    /// Defines the <see cref="CanRedo"/> property
    /// </summary>
    public static readonly DirectProperty<MultiselectTextBox, bool> CanRedoProperty =
        AvaloniaProperty.RegisterDirect<MultiselectTextBox, bool>(nameof(CanRedo), x => x.CanRedo);

    /// <summary>
    /// Defines the <see cref="CopyingToClipboard"/> event.
    /// </summary>
    public static readonly RoutedEvent<RoutedEventArgs> CopyingToClipboardEvent =
        RoutedEvent.Register<MultiselectTextBox, RoutedEventArgs>(
    ...
    public static readonly RoutedEvent<TextChangedEventArgs> TextChangedEvent =
        RoutedEvent.Register<MultiselectTextBox, TextChangedEventArgs>(
    ...
    public static readonly RoutedEvent<TextChangingEventArgs> TextChangingEvent =
        RoutedEvent.Register<MultiselectTextBox, TextChangingEventArgs>(
    ...
    static MultiselectTextBox()
    {
        FocusableProperty.OverrideDefaultValue(typeof(MultiselectTextBox), true);
        TextInputMethodClientRequestedEvent.AddClassHandler<MultiselectTextBox>((tb, e) =>
        {
            if (!tb.IsReadOnly)
            {
    ...
    /// <summary>
    /// Gets or sets a value that determins whether the MultiselectTextBox allows and displays tabs
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets a value whether this MultiselectTextBox is read-only
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the starting position of the text selected in the MultiselectTextBox
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the end position of the text selected in the MultiselectTextBox
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Gets or sets the maximum number of lines the MultiselectTextBox can contain
    /// </summary>
    public int MaxLines
    {
    ...
    /// <summary>
    /// Gets or sets the Text content of the MultiselectTextBox
    /// </summary>
    [Content]
    public string? Text
    {
    ...
    {
        var textBox = (MultiselectTextBox)sender;
    ...
    /// <summary>
    /// Gets or sets the text selected in the MultiselectTextBox
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the <see cref="Media.TextAlignment"/> of the MultiselectTextBox
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the <see cref="Media.TextWrapping"/> of the MultiselectTextBox
    /// </summary>
    ...
    {
        _presenter = e.NameScope.Get<MultiselectTextPresenter>("PART_TextPresenter");
    ...
    {
        if(e.Property == MultiselectTextPresenter.PreeditTextProperty)
        {
    ...
    /// <summary>
    /// Pastes the current clipboard text content into the MultiselectTextBox
    /// </summary>
    ...
    {
        return new MultiselectTextBoxAutomationPeer(this);
    }

    
    public class MultiselectTextBoxAutomationPeer : ControlAutomationPeer, IValueProvider
    {
        public MultiselectTextBoxAutomationPeer(MultiselectTextBox owner)
            : base(owner)
        {
        }

        public new MultiselectTextBox Owner => (MultiselectTextBox)base.Owner;
    ...
    {
        var text = sender.GetValue(TextProperty); // method also used by MultiselectTextPresenter and SelectableTextBlock
    ...
    /// <summary>
    /// Clears the text in the MultiselectTextBox
    /// </summary>
    ...
    /// <summary>
    /// Select all text in the MultiselectTextBox
    /// </summary>
    ...
    /// <summary>
    /// Returns the sum of any vertical whitespace added between the <see cref="ScrollViewer"/> and <see cref="MultiselectTextPresenter"/> in the control template.
    /// </summary>
    ...
    protected override Size MeasureOverride(Size availableSize)
    {
        if(_scrollViewer != null)
        {
            ...
            if (MaxLines > 0 && double.IsNaN(Height))
            {
                ...
                var paragraphProperties = CreateTextParagraphProperties(typeface, fontSize, null, default, default, null, default, LineHeight, default);
    ...
    static TextParagraphProperties CreateTextParagraphProperties(Typeface typeface, double fontSize,
