...
{
    public class MultiselectTextPresenter : Control
    {
        public static readonly StyledProperty<int> CaretIndexProperty =
            MultiselectTextBox.CaretIndexProperty.AddOwner<MultiselectTextPresenter>(new(coerce: MultiselectTextBox.CoerceCaretIndex));

        public static readonly StyledProperty<bool> RevealPasswordProperty =
            AvaloniaProperty.Register<MultiselectTextPresenter, bool>(nameof(RevealPassword));

        public static readonly StyledProperty<char> PasswordCharProperty =
            AvaloniaProperty.Register<MultiselectTextPresenter, char>(nameof(PasswordChar));

        public static readonly StyledProperty<IBrush?> SelectionBrushProperty =
            AvaloniaProperty.Register<MultiselectTextPresenter, IBrush?>(nameof(SelectionBrush));

        public static readonly StyledProperty<IBrush?> SelectionForegroundBrushProperty =
            AvaloniaProperty.Register<MultiselectTextPresenter, IBrush?>(nameof(SelectionForegroundBrush));

        public static readonly StyledProperty<IBrush?> CaretBrushProperty =
            AvaloniaProperty.Register<MultiselectTextPresenter, IBrush?>(nameof(CaretBrush));

        public static readonly StyledProperty<int> SelectionStartProperty =
            MultiselectTextBox.SelectionStartProperty.AddOwner<MultiselectTextPresenter>(new(coerce: MultiselectTextBox.CoerceCaretIndex));

        public static readonly StyledProperty<int> SelectionEndProperty =
            MultiselectTextBox.SelectionEndProperty.AddOwner<MultiselectTextPresenter>(new(coerce: MultiselectTextBox.CoerceCaretIndex));

        /// <summary>
        /// Defines the <see cref="Text"/> property.
        /// </summary>
        public static readonly StyledProperty<string?> TextProperty =
            TextBlock.TextProperty.AddOwner<MultiselectTextPresenter>(new(string.Empty));

        /// <summary>
        /// Defines the <see cref="PreeditText"/> property.
        /// </summary>
        public static readonly StyledProperty<string?> PreeditTextProperty =
            AvaloniaProperty.Register<MultiselectTextPresenter, string?>(nameof(PreeditText));

        /// <summary>
        /// Defines the <see cref="TextAlignment"/> property.
        /// </summary>
        public static readonly StyledProperty<TextAlignment> TextAlignmentProperty =
            TextBlock.TextAlignmentProperty.AddOwner<MultiselectTextPresenter>();

        /// <summary>
        /// Defines the <see cref="TextWrapping"/> property.
        /// </summary>
        public static readonly StyledProperty<TextWrapping> TextWrappingProperty =
            TextBlock.TextWrappingProperty.AddOwner<MultiselectTextPresenter>();

        /// <summary>
        /// Defines the <see cref="LineHeight"/> property.
        /// </summary>
        public static readonly StyledProperty<double> LineHeightProperty =
            TextBlock.LineHeightProperty.AddOwner<MultiselectTextPresenter>();

        /// <summary>
        /// Defines the <see cref="LetterSpacing"/> property.
        /// </summary>
        public static readonly StyledProperty<double> LetterSpacingProperty =
            TextBlock.LetterSpacingProperty.AddOwner<MultiselectTextPresenter>();

        /// <summary>
        /// Defines the <see cref="Background"/> property.
        /// </summary>
        public static readonly StyledProperty<IBrush?> BackgroundProperty =
            Border.BackgroundProperty.AddOwner<MultiselectTextPresenter>();
        ...
        static MultiselectTextPresenter()
        {
            AffectsRender<MultiselectTextPresenter>(CaretBrushProperty, SelectionBrushProperty, TextElement.ForegroundProperty);
        }

        public MultiselectTextPresenter()
        {
        ...
        /// <summary>
        /// Renders the <see cref="MultiselectTextPresenter"/> to a drawing context.
        /// </summary>
