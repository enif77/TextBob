...
public class MultiselectTextBoxUndoRedoHelper<TState>
{
    ...
    private readonly LinkedList<TState> _states = new();
    ...
    public MultiselectTextBoxUndoRedoHelper(IUndoRedoHost host)
    {
        _host = host;
    }
